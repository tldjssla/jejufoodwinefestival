...
class RO_Widget_Mini_Cart extends WC_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<a class="ro-icon" href="javascript:void(0)"><i class="icon icon-basket"></i><span class="cart_total" ></span></a>';
		
		// Insert cart widget placeholder - code in woocommerce.js will update this on page load
		echo '<div class="ro-cart-content"><a class="ro-close" href="javascript:void(0)"><i class="icon icon-wrong6"></i></a><h6>MY SHOPPING CART</h6><div class="widget_shopping_cart_content"></div></div>';
