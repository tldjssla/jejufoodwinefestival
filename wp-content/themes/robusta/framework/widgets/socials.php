...
class RO_Social_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                ...
                __('Socials', 'robusta'), // Name
                array('description' => __('Social Widget', 'robusta'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		php?>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'robusta'); ?></label>
        ...
        for ($i = 1; $i <= 6; $i++) {
            ?>
            <p>
                <label for="<?php echo esc_url($this->get_field_id('icon_social_' . $i)); ?>"><?php _e('Social Icon:', 'robusta');
            echo $i; ?></label>
            ...
            <p>
                <label for="<?php echo esc_url($this->get_field_id('link_social_' . $i)); ?>"><?php _e('Social Link:', 'robusta');
            echo $i; ?></label>
        ...
        <?php } ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('el_class')); ?>"><?php _e('Extra Class:', 'robusta'); ?></label>
