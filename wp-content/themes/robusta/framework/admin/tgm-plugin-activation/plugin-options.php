...
function tb_theme_register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source' => 'http://jwsthemes.com/updrage_plugins/theme_check_required.zip',
            'required' => true,
            'version' => '1.0.0',
        ),
        array(
            ...
            'slug' => 'revslider',
            'source' => 'http://jwsthemes.com/updrage_plugins/revslider.zip',
            'required' => true,
            'version' => '5.0.5',
        ),
        array(
            ...
            'slug' => 'js_composer',
            'source' => 'http://jwsthemes.com/updrage_plugins/js_composer.zip',
            'required' => true,
            'version' => '4.7.4',
        ),
		array(
            'name' => 'Woocommerce',
            'slug' => 'woocommerce',
            'source' => 'https://downloads.wordpress.org/plugin/woocommerce.2.4.7.zip',
            'required' => true,
            'version' => '2.4.7',
        ),
		array(
            'name' => 'Contact Form 7',
            'slug' => 'contact-form-7',
            'source' => 'https://downloads.wordpress.org/plugin/contact-form-7.4.3.zip',
            'required' => true,
            'version' => '4.3',
        ),
		array(
            ...
            'source' => 'https://downloads.wordpress.org/plugin/posts-social-shares-count.1.3.1.zip',
            'required' => true,
            'version' => '1.3.1',
        ),
		array(
