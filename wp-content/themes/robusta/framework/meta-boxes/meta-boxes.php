...
class tbFrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','robusta'), 'page');
		$this->add_meta_box('post_video', __('Video Settings','robusta'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','robusta'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','robusta'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','robusta'), 'post');
		$this->add_meta_box('post_team', __('Team Settings','robusta'), 'team');
		$this->add_meta_box('post_testimonial', __('Testimonial Settings','robusta'), 'testimonial');
	}
