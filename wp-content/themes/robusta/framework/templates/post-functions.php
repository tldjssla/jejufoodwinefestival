...
if ( ! function_exists( 'ro_theme_author_render' ) ) {
	function ro_theme_author_render() {
		...
		<?php if ( is_sticky() && is_home() && ! is_paged() ) { ?>
			<span class="featured-post"> <?php _e( 'Sticky', 'robusta' ); ?></span>
		<?php } ?>
		<div class="ro-about-author clearfix">
			<div class="ro-author-avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), 170 ); ?></div>
			<div class="ro-author-info">
				<h6 class="ro-name"><?php the_author(); ?></h6>
	...
	<div class="ro-avatar">
		...
		<div class="ro-info clearfix">
			...
			<?php if ( $comment->comment_approved == '0' ) : ?>
				<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'robusta' ); ?></em>
				<br />
			<?php endif; ?>
			<span class="ro-time">
				...
				<?php edit_comment_link( __( '(Edit)', 'robusta' ), '  ', '' ); ?>
			</span>
