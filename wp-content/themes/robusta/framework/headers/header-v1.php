...
<!-- Start Header -->
<header>
	<div class="ro-header-v1 ro-header-fixed<?php echo esc_attr($cl_stick) ?>"><!-- ro-header-stick/ro-header-fixed -->
		<div class="container">
			<div class="row">
				<div class="col-md-1">
					<div class="ro-logo">
						<a href="<?php echo esc_url(home_url()); ?>">
							<?php ro_theme_logo('v1'); ?>
						</a>
					</div>
				...
				<div class="col-md-11">
					...
					$arr = array(
						...
						'menu_id' => 'nav',
						'menu' => '',
						'container_class' => 'ro-menu-list hidden-xs hidden-sm '.$manage_location,
