	...
	<div class="main-content ro-blog-sub-article-container-3">
		<div class="container">
			<div class="row">
				...
				$cl_sb_left = isset($tb_options['tb_team_post_left_sidebar_col']) ? $tb_options['tb_team_post_left_sidebar_col'] : 'col-xs-12 col-sm-4 col-md-3 col-lg-3';
				$cl_content = isset($tb_options['tb_team_post_content_col']) ? $tb_options['tb_team_post_content_col'] : 'col-xs-12 col-sm-8 col-md-9 col-lg-9';
				$sb_right = isset($tb_options['tb_team_right_sidebar']) ? $tb_options['tb_team_right_sidebar'] : 'Main Sidebar';
				$cl_sb_right = isset($tb_options['tb_team_post_right_siedebar_col']) ? $tb_options['tb_team_post_right_siedebar_col'] : 'col-xs-12 col-sm-4 col-md-3 col-lg-3';
				?>
				<!-- Start Left Sidebar -->
