...
wp_enqueue_script('ProgressCircle', URI_PATH . '/vc_templates/vc_chart/ProgressCircle.js',array(),"1.0");
wp_enqueue_script('jquery.vc_chart', URI_PATH . '/vc_templates/vc_chart/jquery.vc_chart.js',array(),"1.0");
