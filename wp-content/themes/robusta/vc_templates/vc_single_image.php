...
$image_zoom = ! empty ( $img_url[0] ) && $show_zoom_image ? '<div class="ro-overlay"><a class="ro-zoom-image" href="'.esc_url($img_url[0]).'"><i class="icon icon-resize-full"></i></a></div>': '';
...
if($show_zoom_image) $css_class .= ' vc_zoom_image';

$output .= "\n\t" . '<div class="' . esc_attr( $css_class ) . '">';
$output .= "\n\t\t" . '<div class="wpb_wrapper">';
$output .= "\n\t\t\t" . wpb_widget_title( array( 'title' => $title, 'extraclass' => 'wpb_singleimage_heading' ) );
$output .= "\n\t\t\t" . $image_zoom . $image_string;
