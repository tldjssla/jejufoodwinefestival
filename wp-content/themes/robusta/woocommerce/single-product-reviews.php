			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'label_submit'  => __( 'SUBMIT NOW', 'woocommerce' ),
						'logged_in_as'  => '',
						'comment_field' => ''
					);
					...
					$comment_form['comment_field'] .= '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="Content"></textarea></p>';
